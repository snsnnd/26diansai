...
void LCD_ShowIntNum(u16 x, u16 y, int num, u16 fc, u16 bc, u8 sizey);//显示整数变量
void LCD_ShowFloatNum1(u16 x,u16 y,float num,u8 len,u16 fc,u16 bc,u8 sizey);//显示两位小数变量
void LCD_ShowNegativeFloat(u16 x, u16 y, float num, u8 len, u16 fc, u16 bc, u8 sizey);//显示带符号的两位小数变量
void LCD_ShowFloatNumEx(u16 x, u16 y, float num, u8 dec_len, u16 fc, u16 bc, u8 sizey);//显示带符号的小数变量、可配置小数位数
