...
#define DEBUG_UART_INDEX            ( BLUETOOTH_UART )
#define DEBUG_UART_TX_PIN           ( BLUETOOTH_TX_PIN )
#define DEBUG_UART_RX_PIN           ( BLUETOOTH_RX_PIN )
#define DEBUG_UART_PRIORITY         ( UART2_INT_IRQn )
#else
#define DEBUG_UART_INDEX            ( UART_1 )
#define DEBUG_UART_TX_PIN           ( UART1_TX_A8 )
#define DEBUG_UART_RX_PIN           ( UART1_RX_A9 )
#define DEBUG_UART_PRIORITY         ( UART1_INT_IRQn )
#endif
